defmodule Ident do
  @moduledoc """
  This module provides the ability to make the identicon image based of a string value.
  """

  @doc """
  Main fucntion to generate an image based on the string.
  ...
  def build_pixel_map(%Ident.Image{grid: grid} = image) do
  ...
  def filter_odd_squares(%Ident.Image{grid: grid} = image) do
